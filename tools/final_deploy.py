#!/usr/bin/env python3
"""
Final Working StarkNet Account Deployment
"""
...
async def deploy_account():
    """Deploy account using simple HTTP request"""
    print("🚀 Final StarkNet Account Deployment")
    print("=" * 40)
    ...
    print(f"💰 Balance: 0.014863 ETH (confirmed)")
    ...
    payload = {
        ...
        "params": {
            "deploy_account_transaction": {
                "type": "DEPLOY_ACCOUNT",
                "max_fee": "0x2386f26fc10000",  # 0.01 ETH
                "version": "0x0",
                "signature": [
