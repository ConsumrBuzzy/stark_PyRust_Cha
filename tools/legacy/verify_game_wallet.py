...
def get_balance():
    ...
    eth_token_addr = int(os.getenv("STARKNET_ETH_TOKEN_ADDRESS", "int(os.getenv("STARKNET_ETH_CONTRACT", "0x049d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7"), 16)"), 16)
